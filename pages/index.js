...
export default function Home() {
  ...
  return (
    <div className="mx-auto relative bg-white" >
      ...
      <div className="h-[800px] flex justify-center relative bg-gray-300 cw:h-[600px]">
        <Image src={Section1BG} className="block w-screen" objectFit='cover' objectPosition='center' alt="Meta Legends" />
        <div className="absolute top-1/2 left-1/2 transform whitespace-nowrap cw:whitespace-normal -translate-x-1/2 -translate-y-1/2 text-5xl cw:text-3xl font-medium">
          PRODUCT PHOTOGRAPHY PROFESSIONALS
        </div>
      </div>
      <div className="h-full px-8 grid x-full cw:px-5 sm:px-2">
